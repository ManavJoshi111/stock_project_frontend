          ...
          <div className="container flex justify-center">
            < div className="w-full max-w-xs" >
              <div className="flex flex-col break-words bg-white border border-2 shadow-md mt-20">
                ...
                <a className="mt-3 mb-2 g-signin2" onClick={() => { window.open('https://stocks-project-backend.onrender.com/auth/google', '_self') }} ><span className="g-icon"></span>Login with Google</a>
